...
public final class Bird extends Vector2 {
	...
	private double[] findBestBirdCoords(ArrayList<Bird> otherBirds) throws FunctionEvalLimitException{
		...
		double[] coordsOut=new double[2]; //array for passing out - make sure we pass out a deep copy not the value to the reference.
		...
		System.arraycopy(coords, 0, coordsOut, 0, coords.length);
		return coords;
	}
